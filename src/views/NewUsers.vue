...
<script>
    export default {
        ...
        mounted(){
            ...
            this.$watch(
                ...
                function (newVal, oldVal) {
                    console.log('NewUsers监听到refresh');
                    //做点什么
                    this.list=[];
                }
            )
        ...
        activated(){
            console.log('NewUsers activated');
        },
        deactivated(){
            console.log('NewUsers deactivated');
        },
        destroyed(){
            console.log('NewUsers destroyed');
        },
        methods:{
            query(){
                const that=this;
